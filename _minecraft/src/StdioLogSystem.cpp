...
void StdioLogSystem::LogError(const char * format, ...)
{
	...
	LogInternal(Log::USER_ERROR, format, args);
}
...
void StdioLogSystem::LogWarning(const char * format, ...)
{
	va_list args;
	va_start(args, format);
	LogInternal(Log::USER_INFO, format, args);
}
...
void StdioLogSystem::LogInternal(Log::MSG_TYPE level, const char * format, va_list args)
{
